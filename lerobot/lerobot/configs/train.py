    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return cfg
            ...
            #     for joint in joints:
            #         self.follower_arms[name].write("Position_P_Gain", 800, joint)
            #         self.follower_arms[name].write("Position_I_Gain", 100, joint)
            #         self.follower_arms[name].write("Position_D_Gain", 100, joint)
            #         self.follower_arms[name].write("Profile_Acceleration", 10, joint)
